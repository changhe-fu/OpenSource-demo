...
var templates = [
  ...
  {
    pre: "pre4.png",
    title: lang.customTemplate,
    preHtml: '<h2 style="border-bottom-color:#cccccc;border-bottom-width:2px;border-bottom-style:solid;padding:0px 4px 0px 0px;margin:0px 0px 10px;text-align:center;" class="ue_t">[自定义模板标题]</h2>'
  }
];
